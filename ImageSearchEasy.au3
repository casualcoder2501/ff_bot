...
Const $cMatchLinePercentage = 0.80 ;Minimum matching, put on 1 if exact matching is needed on all lines , So for my purposes I've found that 80% generally yields a good match.
...
Func FindTester($BMP1, $BMP2, $Bool)
	...
	If $CoordsArray[1] = "False" Then ; If Imagesearch fails, error out.
		...
		Exit
	EndIf
	MouseClick("Primary", $CoordsArray[3], $CoordsArray[4]) ; Change here for mousemove / Mouse click / whatever action you're looking for. You can also use a return value to use coordinates outside of this file.
